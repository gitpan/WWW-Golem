# This Makefile is for the WWW::Golem extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/WWW/Golem.pm]
#     AUTHOR => q[Sebastian Enger <thecerial@>]
#     NAME => q[WWW::Golem]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/WWW/Golem.pm]
...
TO_INST_PM = lib/WWW/Golem.pm

PM_TO_BLIB = lib/WWW/Golem.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/WWW/Golem.pm $(INST_MAN3DIR)/WWW::Golem.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:                WWW-Golem' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:             1.0' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:            Perl extension for getting news from http://www.golem.de/' >> META_new.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl extension for getting news from http://www.golem.de/</ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/WWW/Golem.pm blib/lib/WWW/Golem.pm 
